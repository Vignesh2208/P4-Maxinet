...
class MininetManager(object):
    ...
    @Pyro4.expose
    def create_mininet(self, topo, tunnels=[], tk_args = {}, switch=UserSwitch,
        ...
        exercise = ExerciseRunner( mytopo_dir, swlog_dir, pcap_dir, switch_json, sw_exe ,self.tk_args,True)
        ...
        self.logger.info( "Programmed all Switches and Hosts .." )
    ...
    def synchronize_and_freeze(self) :
        self.exercise.synchronize_and_freeze()

    @Pyro4.expose
    def set_netdevice_owners(self) :
        self.exercise.set_netdevice_owners()
