...
class Worker(object):
    ...
    def __init__(self, nameserver, pyroname, pyropw, sshtool, tk_args, switch=UserSwitch):
        """Init Worker class."""
    ...
    def synchronize_and_freeze(self) :
        self.mininet.synchronize_and_freeze()
...
class Cluster(object):
    ...
    def __init__(self, ip=None, port=None, password=None, minWorkers=None, maxWorkers=None,tk_args = {}):
        """Inits Cluster class.
    ...
    def add_worker_by_hostname(self, hostname):
        ...
        if(pyname):
            self.worker.append(Worker(self.nameserver, pyname, self.config.get_nameserver_password(), self.sshtool, self.tk_args))
...
class Experiment(object):
    ...
    def initializeTkInstances(self) :
        for worker in self.worker_objs:
            worker.synchronize_and_freeze()
